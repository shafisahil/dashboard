...
export default function SignInPages(){
  ...
  <div className="max-w-md w-full space-y-8 bg-gray-200 p-8">
    <div>
      ...
      <h2 className=" pl-3 text-3xl  font-bold text-gray-900 ">Create your account</h2>
      </div>
    </div>
    <form className="mt-8 space-y-6" action="#" method="POST">
      ...
      <div className="space-y-4">
          ...
          <input id="email-address" name="text" type="text" required className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Enter your first name"/>
        </div>
        <div className="space-y-4">
